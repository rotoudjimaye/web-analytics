...
SECRET_KEY = 'wf2e%_ic7dv!o(fxv(5+x9qs08&amp;tnecx-_b7fmv%dkp0u5lk!('

# List of callables that know how to import templates from various sources.
TEMPLATE_LOADERS = (
    'django.template.loaders.filesystem.Loader',
    'django.template.loaders.app_directories.Loader',
    'djangojy.template.loaders.jar.Loader',
...
MIDDLEWARE_CLASSES = (
    ...
    'webanalytics.utils.TimezoneMiddleware',
...
## test deployment on red hat OpenShift PaaS
IS_OPENSHIFT = os.environ.get("OPENSHIFT_DATA_DIR") is not None
if IS_OPENSHIFT:
    DATABASES['default'].update({
        'HOST': '127.7.83.129',
        'USER': 'admin',
        'PASSWORD': '_xFu9UXZBFbm',
        'NAME': 'webanalytics'})

DEFAULT_CLIENT_TZ = u"Africa/Douala"
